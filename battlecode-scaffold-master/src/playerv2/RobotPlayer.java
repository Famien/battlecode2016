...
public class RobotPlayer {
	 ...
	 * TODO guard 
	 *
	 *TODO V3= make some players determined
	 */
...
//		}
	...
	private static void archonSignaling() throws GameActionException {
		...
		//
		//		}
		if(leader && (rc.getID() + rc.getRoundNum()) % 3 ==0){//TODO don't keep broadcasting so much
			sendArchonInfo();
		}
	...
	private static void sendArchonInfo() throws GameActionException {
		...
		if(archonFound ){
			...
			targetX = loc.x;
			targetY = loc.y;
			rc.broadcastMessageSignal(MOVE_X, targetX, 1000);
			rc.broadcastMessageSignal(MOVE_Y, targetY, 1000);
